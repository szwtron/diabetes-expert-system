...
const DiagnosisContextProvider: React.FC = props => {
    ...
    const addDiagnosis = (email: string, name: string, telepon: string, sex: string, umur: number, gdp: number, gpp: number, gpt: number, gd2pp: number, hba1c: number, hdl: number, trigliserida: number, insulin: number, hasil: string) => {
